...
export type DatasetLayout_WorkspaceFragment = { __typename?: 'Workspace', name: string, slug: string, permissions: { __typename?: 'WorkspacePermissions', manageMembers: boolean, update: boolean, launchNotebookServer: boolean, delete: boolean }, countries: Array<{ __typename?: 'Country', flag: string, code: string }> };
