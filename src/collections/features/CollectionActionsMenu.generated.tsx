...
export type CollectionActionsMenu_CollectionFragment = { __typename?: 'Collection', id: any, name: string, permissions: { __typename?: 'CollectionPermissions', delete: boolean } };
