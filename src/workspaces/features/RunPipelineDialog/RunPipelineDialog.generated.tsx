...
export type RunPipelineDialog_PipelineFragment = { __typename?: 'Pipeline', id: string, code: string, type: Types.PipelineType, workspace?: { __typename?: 'Workspace', slug: string } | null, permissions: { __typename?: 'PipelinePermissions', run: boolean }, currentVersion?: { __typename?: 'PipelineVersion', id: string } | null };
