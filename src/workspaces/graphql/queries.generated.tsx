...
import { WebPage_PageFragmentDoc } from '../../embeds/WebPage/WebPage.generated';
...
export type WorkspacePageQuery = { __typename?: 'Query', workspace?: { __typename?: 'Workspace', slug: string, name: string, description?: string | null, dockerImage?: string | null, countries: Array<{ __typename?: 'Country', code: string, flag: string, name: string }>, homepage?: { __typename?: 'WebPage', fullWidth: boolean, id: string, title: string, url: string, height?: string | null } | null, permissions: { __typename?: 'WorkspacePermissions', delete: boolean, update: boolean, manageMembers: boolean, launchNotebookServer: boolean } } | null };
