...
export type PipelineVersionConfigDialog_VersionFragment = { __typename?: 'PipelineVersion', id: string, name: string, description?: string | null, externalLink?: any | null, isLatestVersion: boolean, createdAt: any, config?: any | null, pipeline: { __typename?: 'Pipeline', id: string, schedule?: string | null, workspace?: { __typename?: 'Workspace', slug: string } | null }, parameters: Array<{ __typename?: 'PipelineParameter', code: string, name: string, help?: string | null, type: Types.ParameterType, default?: any | null, required: boolean, choices?: Array<any> | null, multiple: boolean }> };
