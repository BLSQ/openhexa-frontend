...
export type CollectionsTable_PageFragment = { __typename?: 'CollectionPage', totalPages: number, totalItems: number, pageNumber: number, items: Array<{ __typename?: 'Collection', id: string, name: string, createdAt: any, updatedAt: any, description?: string | null, author?: { __typename?: 'User', displayName: string } | null, countries: Array<{ __typename?: 'Country', code: string, name: string, flag: string }>, tags: Array<{ __typename?: 'Tag', id: string, name: string }>, authorizedActions: { __typename?: 'CollectionAuthorizedActions', canDelete: boolean, canUpdate: boolean } }> };
